    ...
    <>
      ...
      <main ref={sectionRef}>
        <style>{`
          ...
          .ci-fgrp textarea {
            background: #ffffff;
            border: 1px solid rgba(191, 143, 56, 0.3);
            color: #182849;
            ...
            <div className="ci-grid">
              <div className="ci-reveal">
                ...
                <p className="ci-desc">
                  ...
                  to life. Reach out &mdash; your extraordinary event starts here.
                </p>
              ...
              <div className="ci-reveal">
                <div className="ci-form">
                  ...
                  <div className="ci-fgrp">
                    ...
                    <textarea placeholder="Describe your event dream, any inspiration you have, or specific requests..." />
                  </div>
